...
function suggestQuestion(e, setSuggested) {
    ...
    axios.post(`https://fhirquiz.edge.aidbox.app/QuestionSuggestion`, {suggestion: suggestion})
        .then(res => {
            ...
            <div >
                ...
                <div>
                    <div className="bg-gradient-to-r from-yellow-400/25 to-pink-600/25 rounded-3xl text-white w-1/2 m-auto p-4 mt-4">
                        <div className="opacity-100 outline-0" contenteditable="true" id="suggestion_form">
                            lll
                        </div>
                    </div>
                    ...
                    <div className="m-auto w-40">
                        ...
                        >
                            <a
                                className="p-2 flex items-center rounded-xl text-xl font-medium justify-center w-full bg-transparent hover:text-white duration-500">
                                Submit
                            </a>
                        </div>
                    </div>
